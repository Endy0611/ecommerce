    ...
    <div class="main-content">
        ...
        <div class="data-card">
            <div class="data-card-header">
                ...
                <a href="add_product.php" class="btn-modern btn-primary-modern">
                    <i class="fas fa-plus"></i>
                    Add New Product
                </a>
            </div>
                        ...
                        <?php
                            ...
                            if ($result && $result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td><strong>#" . htmlspecialchars($row['pro_id']) . "</strong></td>";
                                    echo "<td><img src='../images/" . htmlspecialchars($row['img']) . "' width='60' height='60' class='img-thumbnail' style='object-fit: cover;' alt='Product'></td>";
                                    ...
                                    echo "<td><span class='badge bg-info'>" . htmlspecialchars($row['brand_name'] ?? 'N/A') . "</span></td>";
                                    
                                    $price = is_numeric($row['price']) ? number_format($row['price'], 2) : $row['price'];
                                    echo "<td><strong>$" . $price . "</strong></td>";
                                    
                                    $point = str_replace(' pt', '', $row['point']);
                                    echo "<td>" . htmlspecialchars($point) . " pt</td>";
                                    
                                    echo "<td class='text-nowrap'>";
                                    echo "<a href='edit_product.php?id=" . $row['pro_id'] . "' class='btn-modern btn-warning-modern btn-sm me-1'><i class='fas fa-edit'></i></a>";
                                    echo "<a href='delete_product.php?id=" . $row['pro_id'] . "' class='btn-modern btn-danger-modern btn-sm' onclick='return confirm(\"Delete this product?\")'><i class='fas fa-trash'></i></a>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='8' class='text-center text-muted py-5'>No products found. <a href='add_product.php'>Add your first product</a></td></tr>";
                            }
                        ?>
                    </tbody>
                </table>
